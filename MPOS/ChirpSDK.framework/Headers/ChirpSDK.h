...
- (void) setAppKey:(NSString * _Nonnull)key
    ...
    withCompletion:(void (^ _Nullable)(BOOL authenticated, NSError * _Nullable error))completion;
...
/**-----------------------------------------------------------------------------
 * This method is called automatically as soon as the singleton SDK instance is
 * instantiated to start the audio engine running.
 *
 ...
 *----------------------------------------------------------------------------*/
- (void) setChirpHeardBlock:(void (^ _Nullable)(Chirp * _Nullable chirp, NSError * _Nullable error))block;
 ...
 *----------------------------------------------------------------------------*/
- (void) setAudioBufferUpdatedBlock:( void (^ _Nullable)(AudioBuffer * _Nonnull buffer, UInt32 numFrames)) block;
 ...
 *----------------------------------------------------------------------------*/
- (void) setAudioStateChangedBlock:(void (^ _Nullable)(ChirpAudioState audioEngineState))block;
...
/**-----------------------------------------------------------------------------
 * Controls the SDKs streaming mode
 *----------------------------------------------------------------------------*/
@property (nonatomic, assign) ChirpStreamingMode streamingMode;


/**-----------------------------------------------------------------------------
 * The last chirp heard by the SDK, can be nil of no chirp has been received
 *----------------------------------------------------------------------------*/
