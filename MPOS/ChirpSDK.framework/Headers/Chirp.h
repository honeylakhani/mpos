...
/**------------------------------------------------------------------------
 * Initialise a `Chirp` object with an identifier.
 *
...
/**------------------------------------------------------------------------
 * Stop repeated playing this chirp to the current audio output.
 *------------------------------------------------------------------------*/
- (void) stopStreaming;
 ...
 *                   playback begins.
 *------------------------------------------------------------------------*/
- (void) chirpWithCompletion:(void (^ _Nullable)(Chirp * _Nullable chirp, NSError * _Nullable error)) completion;
