...
@end
@implementation MPOSActivityView

static MPOSActivityView *activityView = nil;
...
- (UIImageView *)makeActivityIndicator;
{
  ...
  UIImageView *indicator  = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 50, 50)];
    NSArray *imgArray = [NSArray arrayWithObjects:[UIImage imageNamed:@"nopoint" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil],[UIImage imageNamed:@"onepoint" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil],[UIImage imageNamed:@"twopoint" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil],[UIImage imageNamed:@"threepoint" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil], nil];
...
- (void)layoutSubviews;
{
    ...
    CGRect textRect = [self.activityLabel.text boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin| NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:[UIFont boldSystemFontOfSize:[UIFont  systemFontSize]]} context:nil];
